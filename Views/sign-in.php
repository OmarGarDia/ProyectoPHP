  ...
  <form id="frmLogin">
    <div class="container">
      <div class="row flex-center min-vh-100 py-5">
        <div class="col-sm-10 col-md-8 col-lg-5 col-xl-5 col-xxl-3"><a class="d-flex flex-center text-decoration-none mb-4" href=<?= base_url; ?>index-2.html">
            <div class="d-flex align-items-center fw-bolder fs-5 d-inline-block"><img src="<?= base_url; ?>assets/img/icons/logo.png" alt="phoenix" width="58" /></div>
          </a>
          <div class="text-center mb-7">
            <h3 class="text-1000">Logueate</h3>
            <p class="text-700">Ten acceso a tu cuenta</p>
          </div><button class="btn btn-phoenix-secondary w-100 mb-3"><span class="fab fa-google text-danger me-2 fs--1"></span>Logueate con Google</button><button class="btn btn-phoenix-secondary w-100"><span class="fab fa-facebook text-primary me-2 fs--1"></span>Logueate con Facebook</button>
          <div class="position-relative">
            <hr class="bg-200 mt-5 mb-4" />
            <div class="divider-content-center">o usa tu Email</div>
          </div>
          <div class="mb-3 text-start"><label class="form-label" for="email">Dirección de correo</label>
            <div class="form-icon-container"><input class="form-control form-icon-input" id="loginEmail" name="loginEmail" type="email" placeholder="nombre@ejemplo.com" /><span class="fas fa-user text-900 fs--1 form-icon"></span></div>
          </div>
          <div class="mb-3 text-start"><label class="form-label" for="password">Contraseña</label>
            <div class="form-icon-container"><input class="form-control form-icon-input" id="loginPassword" name="loginPassword" type="password" placeholder="Contraseña" /><span class="fas fa-key text-900 fs--1 form-icon"></span></div>
          </div>
          <div class="row flex-between-center mb-7">
            <div class="col-auto">
              <div class="form-check mb-0"><input class="form-check-input" id="basic-checkbox" type="checkbox" checked="checked" /><label class="form-check-label mb-0" for="basic-checkbox">Recordarme</label></div>
            </div>
            <div class="col-auto"><a class="fs--1 fw-semi-bold" href="forgot-password.html">¿Olvidaste tu contraseña?</a></div>
          </div><button type="submit" class="btn btn-info w-100 mb-3" onclick="frmLogin(event)">Entrar</button>
...
<div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
  <div class="offcanvas-header align-items-start border-bottom flex-column">
    <div class="pt-1 w-100 mb-6 d-flex justify-content-between align-items-start">
      <div>
        <h5 class="mb-2 me-2 lh-sm"><span class="fas fa-palette me-2 fs-0"></span>Customizar la plantilla</h5>
        <p class="mb-0 fs--1">Explora diferentes estilos acorde a tus preferencias</p>
