          ...
          <div class="card-header bg-primary">
            <div class="app-brand">
              <a href="/index.html">
                ...
                <span class="brand-name">Proyecto PHP</span>
              </a>
            </div>
          </div>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="d-flex my-2 justify-content-between">
                    ...
                    <p><a class="text-blue" href="recuperar-contrasena">¿Olvidaste tu contraseña?</a></p>
                  </div>

                  <button type="submit" class="btn btn-lg btn-primary btn-block mb-4">Entrar</button>

                  <p>¿No tienes cuenta todaviaa?
                    <a class="text-blue" href="sign-up">Registrate</a>
                  </p>
                </div>
              </div>
            </form>
